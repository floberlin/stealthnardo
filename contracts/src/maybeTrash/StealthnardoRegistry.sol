...
//    */
//   function registerKey(address _registrant, uint256 _PubKeyX, uint256 _PubKeyY) external {
...
//    */
//   function stealthKeys(address _registrant) public view returns (uint256 PubKeyX, uint256 PubKeyY) {
